...
export async function runSeed(db) {
  ...
  guard('debts', (await db.from('debts').insert(withUid([
    ...
    { name: 'Friend Loan', balance: 20000.00, apr: 0.00, plan_payment: 1000.00, min_payment: 0.00, due_day: null, kind: 'loan', active: true, is_collection: false, autopay: false, credit_limit: null, original_creditor: null, settlement_amount: null, plan_end_date: null, activity_charge: null },
